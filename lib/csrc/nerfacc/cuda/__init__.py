...
rendering_alphas_forward_with_transmittance = _make_lazy_cuda_func("rendering_alphas_forward_with_transmittance")

unpack_data = _make_lazy_cuda_func("unpack_data")
unpack_info = _make_lazy_cuda_func("unpack_info")
unpack_mask = _make_lazy_cuda_func("unpack_mask")
